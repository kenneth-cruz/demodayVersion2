...
//console.log redirects you back to profile.ejs (refresh)
      ...
      console.log(uId)
      debugger
      db.collection('topics').save({swipeRight: true, posterId: uId, topic:req.body.topic, link: req.body.link, imageSRC: req.body.imageSRC}, (err, result) => {
        if (err) return console.log(err)
